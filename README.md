...
## Lessons Learnt
1. THE SYSTEM WHERE THE CABLE IS PLUGGED IN THE SCRIPT CAN BE EXECUTED ON
2. ATTACK CAN COME FROM DIFFERENT DEVICES AS LONG AS IT IS CONNECTED TO THE OMG WIFI AND THE CABLE IS PLUGGED
